    ...
    <>
      <nav className={`${styles.navbar} `}>
        <span className="navbar-brand d-flex align-items-center">
          ...
          <a href="/" style={{textDecoration:"none"}}><span style={{ color: "white", fontSize:"1.8rem" }} className="mx-3 mt-5 ">The Haven</span></a>
        </span>
        <span className={`${styles.navbar_right_side} navbar-brand`}>
