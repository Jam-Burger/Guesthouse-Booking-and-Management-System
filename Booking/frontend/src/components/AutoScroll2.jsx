    ...
    return (
        <div className="slider">
            <div className="cards">
                ...
                <div className="indCard">
                    <img src="https://thepointsguy.global.ssl.fastly.net/us/originals/2022/04/THE-MURAKA_Undersea-Bedroom_Couple_Day_Hero_credit-Justin-Nicholas-hi-res.jpg"  alt='4'/>
                </div>
                <div className="indCard">
