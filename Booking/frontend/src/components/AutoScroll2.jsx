    ...
    return (
        <div className="slider">
            <div className="cards">
                ...
                <div className="indCard">
                    <img src="https://www.tajhotels.com/content/dam/luxury/hotels/Taj_Lands_End_Mumbai/images/4x3/R&S_WOGLI_Exterior-Master.jpg" alt='3' />
                </div>
                <div className="indCard">
                    <img src="https://www.luxuryabode.com/mona/img/hotels.jpg"  alt='4'/>
                </div>
                <div className="indCard">
                ...
                <div className="indCard">
                    <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/224775490.jpg?k=d592254d49861d0523e69e265bad380e89b1d1c4785cde7503fa3dbd582a69ca&o=&hp=1" alt='6'  />
                </div>
                <div className="indCard">
