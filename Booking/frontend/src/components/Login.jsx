      ...
      <div className="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
        <div className="w-full bg-cover relative max-w-md lg:max-w-2xl lg:w-7/12">
          <div className="flex flex-col items-center justify-center w-full h-full relative lg:pr-10">
            <img src="./images/logoJug_beyondSky-removebg.png" className="btn- backImg" />
          </div>
        </div>
            ...
            <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
              <form action="/success" method="post">
                ...
                <div className="relative textBoxes">
                  ...
                  <p id='hyperLink'>New to Here? <a href='./signup' type='submit' action='/sigin' method='post'><b>Sign Up</b></a> a new Account Right Now!</p>
                </div>
              </form>
            </div>
          </div>
          <svg viewBox="0 0 91 91" className="absolute top-0 left-0 z-0 w-32 h-32 -mt-12 -ml-12 text-cyan-300 fill-current">
