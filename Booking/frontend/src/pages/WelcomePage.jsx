            ...
            <div className="relative bg-[#f8f2ed] overflow-x-hidden">
                <div className="mb-4 flex flex-col items-center justify-between ">
                    <div className="relative w-full overflow-hidden bg-cover bg-no-repeat">
                        <img src="./images/_backImg6.jpg" className="w-full coverImg " />
                        <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-black bg-fixed opacity-50">
                            <div className="opacity-100 flex-col flex h-full items-center justify-center">
                                <h1 className="opacity-100 mb-4 text-8xl font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-8xl">beyondSky</h1>
                                <h1 className="opacity-100 mb-4 text-6xl italic font-bold leading-none tracking-tight text-white md:text-4xl lg:text-6xl">The sky is Not the Limit!</h1>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col items-center w-full justify-center pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-col">
                        <h1 className="mb-6 text-5xl font-bold text-center pt-10 pr-10 pb-1 pl-10 text-black cursive">Welcome to our Hotel!</h1>
                        <div className="flex flex-row items-center w-full justify-center pt-5 pr-10 pb-1 pl-10 lg:pt-5 lg:flex-row">
                            ...
                            <h2 className="mb-6 text-4xl font-light italic text-center py-10 px-6 text-black cursive">Where accommodation meets expection.</h2>
                        ...
                        <div className="masking w-full flex flex-col h-full justify-center items-center overflow-hidden bg-cover">
                            <div style={{ backgroundColor: 'rgba(0, 0, 0, 0.75)' }} class="absolute flex flex-col justify-center items-center content-center  bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed">
                                <div className="maskingText w-full ">
                                    <h1 className="text-white text-center text-4xl font-bold cursive">Want to book a Hotel?</h1>
                                    <button 
                                        type='button'
