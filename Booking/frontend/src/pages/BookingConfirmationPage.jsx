      ...
      <div className="relative overflow-hidden mb-5">
        <div className="cheh d-flex flex-col justify-content-center items-center overflow-hidden bg-cover">
          <div
            ...
            className="absolute d-flex justify-content-center align-items-center h-100 w-100 overflow-hidden bg-fixed"
          >
        ...
        <div className="container align-content-center mt-5 mb-3 mw-25">
          <div className="printCard card ">
            ...
            <div className="card-body ">
              ...
              <div className="print-area p-2 ">
                ...
                <div className="row w-full d-flex justify-content-between">
                ...
                <div className="row">
                  <p className="mt-2 d-flex justify-content-end">
                    {"Amount Paid:"} &#160;
                    <span className="fw-bold"> INR {amount}/-</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row pt-3">
            <div className="col d-flex justify-content-start">
              ...
              >
                Go <i className="fas fa-circle-check"></i> Home
              </button>
            </div>
